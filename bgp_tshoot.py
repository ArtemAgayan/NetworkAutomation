...
# Instead of log in to this box and gather all information manually, a Python script can be used which will collect some basic information.
...
# For convenience, before execution script will ask an ip-addresses of the switch and an ip-address of the bgp-peer, so there is no need to go to .py file and specify this values every time.
...
# making a lab, so please excuse me for this. I just add here the dump output from another working neighbor for better understanding.)
#
# % ./bgp_tshoot.py   
